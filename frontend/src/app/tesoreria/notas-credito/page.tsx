...
import { FileMinus, Pencil, Plus, Search, Trash2, X as CloseIcon, Eye, ExternalLink, FileText, FileCode2, RefreshCw } from "lucide-react";
...
import {
  ...
  listNotasCredito,
  sincronizarDriveNotaCredito,
  updateNotaCredito,
  urlVerNotaCreditoPdf,
} from "@/lib/tesoreria";
                      ...
                      <Paper key={tipo} variant="outlined" sx={{ p: 1.5 }}>
                        <Stack direction="row" spacing={1.5} alignItems="center" justifyContent="space-between">
                          <Stack direction="row" spacing={1.5} alignItems="center">
                            ...
                            <Typography variant="body2">
                              {tipo === "pdf" ? "Nota de Crédito (PDF)" : "Comprobante Fiscal (XML)"}
                            </Typography>
                          </Stack>
                          <Stack direction="row" spacing={1} alignItems="center">
                            <IconButton
                              ...
                              onClick={() => {
                                ...
                                if (tipo === "pdf") {
                                  setPreviewDoc({
                                    url: urlVerNotaCreditoPdf(editing.id),
                                    titulo: `Nota ${editing.comprobante_folio || editing.timbre_uuid} — PDF`,
