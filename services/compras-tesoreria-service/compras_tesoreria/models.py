...
# Nota general: este servicio combina Tesoreria + CFDI/Facturacion + el
# maestro de Contrapartes en un solo esquema (el split documentado en
# docs/architecture/README.md sec. 1.1 - contrapartes-service /
# tesoreria-service / facturacion-cfdi-service como servicios separados -
# no se ha ejecutado todavia en codigo; ver rama split-tesoreria-rentas-
# services). compras-service no tiene tablas propias en el ERD actual
# (dominio nuevo de Fase 4, ver Supuestos y puntos abiertos del doc de
# arquitectura) por eso no aparece aqui ningun modelo de compras.
